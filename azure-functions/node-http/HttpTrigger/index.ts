...
const httpTrigger = async function (
  ...
  const metadata: WelcomeData = {
    database: context.db.advanced.documentStore.database,
    url: context.db.advanced.documentStore.urls[0],
    version: undefined,
    connected: true,
  ...
  try {
    const { productVersion } =
      await context.db.advanced.documentStore.maintenance.send(
  ...
  context.res = {
    body: getWelcomeTemplate(metadata),
    status: 200,
		...
		<div class="row">
			<div class="col">
				<div class="card">
                  ...
                  <svg class="icon-power icon-addon">
                ...
                <strong>Microsoft Azure</strong>
						...
						<div class="card-header-actions">
							<a class="btn btn-sm btn-secondary" href="https://portal.azure.com/#blade/HubsExtension/BrowseResourceBlade/resourceType/Microsoft.Web%2Fsites/kind/functionapp">
            ...
            <dd class="col-sm-8">${data.functionName}</dd>
            <dt class="col-sm-4">Invocation ID</dt>
            <dd class="col-sm-8">${data.invocationId}</dd>
						</dl>
					</div>
				</div>
			</div>
              ...
              <i class="icon">
                ...
                <svg class="icon-home icon-addon">
                  <use xlink:href="#icon-home"></use>
						...
						<div class="card-header-actions">
							<a class="btn btn-sm btn-secondary" target="_blank" href="${
                data.url
              }/studio/index.html">
                <svg class="icon icon-new-tab">
                  <use xlink:href="#icon-new-tab"></use>
...
${data.error.stack}</code></pre>
		...
		<div class="next-steps row">
			<div class="col">
				<div class="card">
					...
					<div class="card-body">
            <p>
              Update your <code>local.settings.json</code> configuration with
  ...
  "DB_CERT_PASSWORD": "&lt;your_password&gt;"
            ...
            <p>
              ...
              <a href="#docs">Using Azure Functions with RavenDB</a>.
            </p>
					</div>
				</div>
			</div>
